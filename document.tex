...
\newcommand{\examinerA}{Alexander Co Abad}

\newcommand{\examinerBTitle}{Engr.} 
\newcommand{\examinerB}{Dino Dominic F. Ligutan}
...
\begin{document}
	...
	scale=0.65,%
	pagecommand={},
	]{./figure/defense_revision.pdf} % Includes all pages (1 to 5)
	%\stopcontents[chapters]
	\cleardoublepage

  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\chapter{Questionnaire to the Expert} 
	...
	scale=0.75,%
	pagecommand={},
	]{./figure/comparative_test_paper.pdf} % Includes all pages (1 to 5)
	%\stopcontents[chapters]
	\cleardoublepage

  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\chapter{Certificate from Farmers} 
	\label{ch:cert_farmer}
	%\startcontents[chapters]
	%\Mprintcontents  
	%\include{revisions_to_the_proposal}
	...
	scale=0.67,%
	pagecommand={},
	]{./figure/farmer_cert.pdf} % Includes all pages (1 to 5)
	%\stopcontents[chapters]
	\cleardoublepage

  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\chapter{Dataset Validation} 
	\label{ch:dataset_validation}
	%\startcontents[chapters]
	%\Mprintcontents  
	%\include{revisions_to_the_proposal}
	\includepdf[pages={1-26},
	offset=3.5mm -10mm,%
	scale=0.75,%
	pagecommand={},
	]{./figure/dataset_validation_paper.pdf} % Includes all pages (1 to 5)
	%\stopcontents[chapters]
	\cleardoublepage
