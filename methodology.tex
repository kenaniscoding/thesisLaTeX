...
In the image acquisition system, the mango is always positioned above the camera and parallel to the metallic rollers and gap. This is so that the size classification would be consistent for both image capturing attempts. Once the mango has already been graded, the mango would exit the image acquisition system parallel to the metallic rollers and parallel to the long conveyor belt. In the case that the mango would go towards the small conveyor belt, it would be perpendicular to the small conveyor belt.
...
Figure~\ref{fig:mango_pos} shows the position of the mango from the image acquisition system which are the mangoes labeled 1 and 2.
When the mango is already graded, it would be sorted using the T sorter seen on mangoes 3, 3.1, and 3.2.
