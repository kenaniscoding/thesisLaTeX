...
\subsubsection{Green}
Explain the characteristics of a green mango
\subsubsection{Yellow\_Green}
Explain the characteristics of a yellow green mango
\subsubsection{Yellow}
Explain the characteristics of a yellow mango
...
Stem end rots are characterized by fast-growing, watery, soft rots that penetrate deeply into the flesh. 
...
Dendritic spots, on the other hand, are small black spots with irregular edges scattered across the skin. 
Furthermore, it grow slowly and do not penetrate into the flesh, remaining largely superficial.

\subsubsection{Anthracnose}
Anthracnose appears in two forms. First form is through body anthracnose. 
...
Sapburn appears as dark brown spots or blotches that are often slightly sunken. 
...
Skin browning may take two forms. First form is abrasion while the second form is sap browning. 
...
Lenticel spots are another common defect, appearing as round or star-shaped brown spots scattered across the skin surface. 
