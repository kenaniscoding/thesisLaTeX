...
% % Table: CNN Training Results for GPU (with Train Accuracy)
% \begin{table}[htbp]
% \centering
...
% \hline
% RESNET50 & 0.870 & 0.869 & 0.868 & 87 & 83.58 & 7h13m & 4.1 \\
% \hline
% GOOGLENET & 0.898 & 0.895 & 0.892 & 89 & 83.58 & 3h3m & 2.9 \\
% \hline
% MOBILENETV2 & 0.898 & 0.898 & 0.897 & 90 & 91.84 & 2h0m & 3.6 \\
% \hline
% DENSENET121 & 0.877 & 0.877 & 0.875 & 88 & 91.37 & 2h10m & 5.5 \\
% \hline
% EFFICIENTNET B0 & 0.890 & 0.888 & 0.887 & 89 & 91.47 & 2h26m & 4.1 \\
% \hline
% EFFICIENTNET B1 & 0.867 & 0.862 & 0.859 & 86 & 89.91 & 2h30m & 5.3 \\
% \hline
% EFFICIENTNET B2 & 0.927 & 0.924 & 0.925 & 92 & 90.27 & 2h14m & 5.5 \\
% \hline
% EFFICIENTNET B3 & 0.882 & 0.880 & 0.879 & 88 & 91.84 & 2h25m & 6.8 \\
% \hline
% EFFICIENTNET B4 & 0.899 & 0.898 & 0.896 & 90 & 92.34 & 2h50m & 8.0 \\
% \hline
% EFFICIENTNET B5 & 0.925 & 0.924 & 0.924 & 92 & 92.84 & 5h49m & 11.6 \\
% \hline
% EFFICIENTNET B6 & 0.934 & 0.933 & 0.933 & 93 & 96.03 & 7h51m & 14.5 \\
% \hline
% EFFICIENTNET B7 & 0.883 & 0.871 & 0.873 & 87 & 90.03 & 10h34m & 18.8 \\
% \hline
% EFFICIENTNETV2-B0 & 0.915 & 0.913 & 0.913 & 91 & 89.91 & 1h53m & 3.0 \\
% \hline
% EFFICIENTNETV2-B1 & 0.904 & 0.904 & 0.902 & 90 & 92.56 & 2h0m & 3.6 \\
% \hline
% EFFICIENTNETV2-B2 & 0.902 & 0.900 & 0.901 & 90 & 92.34 & 2h17m & 3.8 \\
% \hline
% EFFICIENTNETV2-B3 & 0.926 & 0.926 & 0.925 & 93 & 92.91 & 2h2m & 4.5 \\
% \hline
% EFFICIENTNETV2-S & 0.894 & 0.893 & 0.891 & 89 & 90.47 & 1h59m & 6.1 \\
% \hline
% EFFICIENTNETV2-M & 0.893 & 0.893 & 0.892 & 89 & 90.47 & 2h58m & 9.9 \\
% \hline
% EFFICIENTNETV2-L & 0.875 & 0.871 & 0.870 & 87 & 89.09 & 14h58m & 16.8 \\
% \hline
% \textbf{AVERAGE} & \textbf{0.830} & \textbf{0.852} & \textbf{0.835} & \textbf{85} & \textbf{85.52} & \textbf{--} & \textbf{7.0} \\
% \hline
% \end{tabular}
% \caption{CNN Training Results for GPU including Train Accuracy}
% \label{tab:cnn_training_gpu}
% \end{table}
\begin{table}[htbp]
\centering
\begin{tabular}{l|c|c|c|c|c|c|c}
...
\subsection{Analysis of Table~\ref{tab:overall_accuracy_cnn}}
...
\subsection{Method 1: Real World Object Size Calculation via Foreground Masking and Thresholding}
...
which are the original image taken with the \acr{RPi} camera on the image acquisition system
...
acquisition system which is why the conveyor belt isn’t white. Note that the Equation~\ref{eq:objectSizeCalculation2} 
is used to convert the pixel measurements to get the dimensions in centimeters.
...
\subsection{Method 2: Object Detection using Faster-RCNN}
...
Note that the V2 Code refers to \textit{Method 2 (Object Detection)}, while the V1 Code refers to \textit{Method 1 (Real-World Object Size Calculation)}.

Tables~\ref{tab:more_size_results01}, \ref{tab:more_size_results02}, \ref{tab:more_size_results03}, and~\ref{tab:mean_and_std_results} present the mango size estimation results using both V1 and V2 methods compared against the ground truth measurements. The results indicate that the V2 (Object Detection) method achieved higher accuracy and consistency in predicting both length and width dimensions compared to V1 (Real-World Object Size Calculation).

As shown in Tables~\ref{tab:more_size_results01} to~\ref{tab:more_size_results03}, individual sample results demonstrate that the V2 method consistently produces values closer to the actual mango dimensions. Table~\ref{tab:mean_and_std_results} summarizes the overall statistical performance of both methods, showing that the V2 method achieved a mean length difference of 1.75 cm with a standard deviation of 0.56 cm, while the V1 method yielded a mean difference of 1.54 cm and a standard deviation of 0.40 cm. Although both methods performed similarly in estimating length, V2 demonstrated significantly better performance in estimating width, with an average difference of only 0.47 cm compared to the 4.61 cm mean error of V1.

Furthermore, the percentage difference data in Table~\ref{tab:mean_and_std_results} reveal that V2 achieved an average of 13.57\% for length and 3.24\% for width, whereas V1 recorded 12.04\% for length but a notably higher 56.89\% for width. This large discrepancy in V1’s width estimation suggests that the Real-World Object Size Calculation method is more prone to scaling and calibration errors, especially along the horizontal dimension. In contrast, the Object Detection approach provided more stable and reliable measurements across all samples.

Overall, as supported by Tables~\ref{tab:more_size_results01} to~\ref{tab:mean_and_std_results}, the analysis shows that the Object Detection (V2) method offers improved precision and robustness for estimating mango dimensions, particularly in width estimation, making it more suitable for getting the mango's size.
...
the conveyor belt. Both of these parts are being controlled by an \acr{RPi} through a python script.
...
the shorter conveyor depending on the grade.
...
sorting system, demonstrating its successful integration of software intelligence, hardware
...
superior, offering an optimal balance of accuracy and computational efficiency. For
physical attribute measurement, an object detection method (Faster R-CNN) was established
as the most reliable technique for determining mango size, significantly outperforming a
traditional computer vision approach. The system's practical validity was further
