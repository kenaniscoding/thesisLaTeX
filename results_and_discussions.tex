...
With the model using Naive Bayes the precision scores are quite low with both
green and yellow to be around 79 percent. It seems to be struggling to identify
yellow-green with a score of 58 percent. The recall metric of the model suggests
that it had an easier time identify true postives of yellow with a score of 86
percent while it struggled to identify yellow-green as it has a low score of 51
percent. the F1 score suggest the same of the other metrics that the model
struggles to correctly identify yellow-green mangoes with a socre of 55 percent.
