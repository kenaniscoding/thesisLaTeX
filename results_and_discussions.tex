...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_1_bottom}
	\caption{Bottom Side Mango 1}
	\label{fig:mango_1_bottom}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_1_fgMask_bottom}
	\caption{Mango 1 with Foreground Masking}
	\label{fig:mango_1_fgMask_bottom}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_1_thresh_bottom}
	\caption{Mango 1 with Thresholding}
	\label{fig:mango_1_thresh_bottom}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_2_bottom}
	\caption{Bottom Side Mango 2}
	\label{fig:mango_2_bottom}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_2_thresh_bottom}
	\caption{Mango 2 with Thresholding}
	\label{fig:mango_2_thresh_bottom}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_background}
	\caption{Background Side Mango 3}
	\label{fig:mango_3_background}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_bottom}
	\caption{Bottom Side Mango 3}
	\label{fig:mango_3_bottom}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_fgMask_bottom}
	\caption{Mango 3 with Foreground Masking}
	\label{fig:mango_3_fgMask_bottom}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_thresh_bottom}
	\caption{Mango 3 with Thresholding}
	\label{fig:mango_3_thresh_bottom}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_top}
	\caption{Top Side Mango 3}
	\label{fig:mango_3_top}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_fgMask_top}
	\caption{Mango 3 with Foreground Masking}
	\label{fig:mango_3_fgMask_top}
\end{figure}
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{mango_3_thresh_bottom}
	\caption{Mango 3 with Thresholding}
	\label{fig:mango_3_thresh_top}
\end{figure}
