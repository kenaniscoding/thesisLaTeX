...
\begin{table}[htbp]
	...
	\begin{tabular}{c|c|c|c|c}
	  ...
	  \hline
	  Accuracy &  \multicolumn{2}{c|}{ }  & 0.93 & 2661 \\
	  \hline
	  ...
	  \hline
	\end{tabular}
	\caption{Ripeness Classification Report using CNN}
	\label{tab:ripeness_classification_report}
\end{table}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{/effnet-b4-ripeness/confusion_matrix_ripeness}
	\caption{Ripeness Confusion Matrix using CNN}
...
\begin{figure}[!htbp]
    ...
    \subbottom[Test Image Size]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-ripeness/test_class_distribution_ripeness}
        \label{fig:ripeness_test_cnn}
    }
    \hfill
    \subbottom[Train Image Size]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-ripeness/train_class_distribution_ripeness}
        \label{fig:ripeness_train_cnn}
    }
    \vfill
    \subbottom[Validation Image Size]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-ripeness/valid_class_distribution_ripeness}
        \label{fig:ripeness_valid_cnn}
    }
    \hfill
    \subbottom[Validation Accuracy and Loss Plot]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-ripeness/val_loss_accuracy_curve_ripeness}
        \label{fig:val_curve_cnn}
    }
    \caption{Ripeness Training and Testing}
...
% todo: replace the results with kenan's current results
\begin{table}[htbp]
	\centering
	\begin{tabular}{c|c|c|c|c}
	  \hline
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{/effnet-b4-bruises/confusion_matrix_bruises}
...
\begin{figure}[!htbp]
    \centering
    \subbottom[Test Image Size]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-bruises/test_class_distribution_bruises}
        \label{fig:bruises_test_cnn}
    }
    \hfill
    \subbottom[Train Image Size]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-bruises/train_class_distribution_bruises}
        \label{fig:bruises_train_cnn}
    }
    \vfill
    \subbottom[Validation Image Size]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-bruises/valid_class_distribution_bruises}
        \label{fig:bruises_valid_cnn}
    }
    \hfill
    \subbottom[Validation Accuracy and Loss Plot]{
        \includegraphics[width=0.45\textwidth]{/effnet-b4-bruises/val_loss_accuracy_curve_bruises}
        \label{fig:val_curve_cnn}
    }
...
\begin{figure}[!htbp]
    ...
    \subbottom[Version 2.1 with Background Image]{
        \includegraphics[width=0.45\textwidth]{UI_v4}
        \label{fig:app_v4}
    }
    \hfill
    \subbottom[Version 2.2 without Background Image]{
        \includegraphics[width=0.45\textwidth]{UI_v5}
        \label{fig:app_v5}
    }
