...
the small, medium, and large classification with a 3$\text{cm}^3$ is shown in Figure~\ref{fig:size_rev5} These findings confirm that the methodology is effective for non-destructive 
...
\begin{figure}[!htbp]
	...
	\caption{Size Area Classification with $\text{cm}^3$ Gap}
	\label{fig:size_rev5}
\end{figure}
