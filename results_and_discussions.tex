...
Several major modifications to the training pipeline improved overall model effectiveness significantly.
 ...
 The optimizer was changed from Adam to AdamW for stronger regularization.
...
\hline
\end{tabular}
\caption{CNN Training Results for CPU}
...
DenseNet121 at 88\%, and ResNet50 at 87\%. In contrast, both VGGNet16 and
...
at 87\% and MobileNetV2 at 86\%. ResNet50 and DenseNet121 both reached 84\%,
