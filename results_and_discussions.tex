...
the small, medium, and large classification with a 3$\text{cm}^3$ is shown in Figure~\ref{fig:size_rev5} and the more than 
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{/size_rev/ks}
