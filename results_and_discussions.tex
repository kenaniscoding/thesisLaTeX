...
In the case the user inputs a a letter or negative value,
...
Figure~\ref{fig:ripeness-all} shows an example output
...
% todo add summary to this results and discussion
