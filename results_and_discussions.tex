...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccc}
        \toprule
        \textbf{Mango ID} & \textbf{Side} & \textbf{Color Category} & \textbf{Bruising Status} \\
        \midrule
        001 & A & Yellow-Green & Non-Bruised \\
        001 & B & Green        & Non-Bruised \\
        002 & A & Yellow       & Bruised     \\
        002 & B & Yellow-Green & Non-Bruised \\
        003 & A & Green        & Non-Bruised \\
        003 & B & Green        & Non-Bruised \\
        \vdots & \vdots & \vdots & \vdots \\
        030 & A & Yellow       & Non-Bruised \\
        030 & B & Yellow       & Non-Bruised \\
        \bottomrule
    \end{tabular}
\end{table}
...
Note that the current tested Faster RCNN MobileNetV3-Large-FPN was trained with
batch size of 2 images per iteration, with data shuffling enabled to ensure random 
sampling during training epochs with the optimization process utilized 
Stochastic Gradient Descent (SGD) 
with a learning rate of 0.005, momentum of 0.9, and weight decay of 0.0005 to prevent
