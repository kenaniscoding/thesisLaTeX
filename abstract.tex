...
For size classification, two approaches (Computer Vision and Object Detection) were assessed for estimating mango length and width. 
\acr{Faster R-CNN} demonstrated the best overall performance, with measured length and width differences of 13.57\% and 3.24\% 
from the ground truth, respectively. Finally, the image acquisition system, consisting of an \acr{RPi} with a camera module 
