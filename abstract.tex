...
Different machine learning methods were tested for classifying ripeness and bruises separately. The dataset comprised of online available images and researchers' own Carabao mango images. Convolutional Neural Networks, specifically EfficientNetV2, achieved optimal performance for ripeness and bruises classification with accuracy scores of 98\% and 99\% respectively. For size classification, two methods (Computer Vision and Object Detection) were evaluated for measuring mango length and width. Faster R-CNN with object detection achieved best overall performance, with length and width measurements showing 13.57\% and 3.24\% differences from ground truth respectively. Finally, the image acquisition system consisting of Raspberry Pi 4B with camera module and conveyor belt successfully demonstrated grading and sorting using the developed linear grading formula.
