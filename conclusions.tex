...
\begin{itemize}
  \item BANAL Kenan A.: Scrum Master (Project manager in charge of the hardware
      and software integration, assisted in mango size determination, incharge
        of dataset collection and data augmentation, assisted in mango size
  ...
  and hardware assistant of the Scrum Master, assisted in dataset splitting,
        categorization and collectio, assisted in mango size determination and
        estimation) 
  ...
  the machine learning algorithm, assisted in dataset collection and data
        augmentation, assisted in mango size determination and estimation)
\end{itemize}


\section{Recommendations}

The researchers recommend that the prototype be enhanced through the
optimization of the machine learning algorithm and the refinement of the
hardware design, with further testing in the actual grading and sorting of
Carabao mangoes in the market. To strengthen its performance and reliability,
the improvements should include expanding the dataset by incorporating a larger
number of mango samples, utilizing the latest available machine learning models
at the time of implementation, and updating the size determination method by
applying recent advancements in machine learning and computer vision. In
addition, the prototype should integrate weight determination through the use of
weight sensors, implement a non-destructive technique for sweetness detection,
and employ industry-grade equipment to ensure robust implementation and
automation.
