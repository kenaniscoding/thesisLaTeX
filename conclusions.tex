...
For SO6, the  system utilized OpenCV for contour extraction and geometric calculations, and Faster
R-CNN for object detection, resulting in an average deviation of 13.57\% in length and 3.24\% in width from 
ground-truth measurements, indicating reliable dimensional estimation.
