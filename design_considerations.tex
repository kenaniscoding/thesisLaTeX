...
\subsection{Open-source Software Compliance - ISO/IEC 5230e}
It ensures that organizations using open-source components in their products maintain proper documentation, 
...
% \section{Classification Model Validation}
% todo add the done prototyep simulation such as error testing and fake gpio and fake rpi cam
...
% % todo MIGHT DELETE THIS CAUSE WE DIDT VALIDATE THE DESIGN
