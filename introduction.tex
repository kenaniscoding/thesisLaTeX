...
\gls{Carabao mango} \textit{(Mangifera indica L.)} is a variety of a mango that is found and
cultivated in the Philippines. It is known for its sweet signature taste that was recognized
...
bright yellow color when ripe as seen in Figure \ref{fig:img1} \citep{knight2009_mango}. It is often cultivated
during late May to early July \citep{aciar2019_philippine_mango}.

Likewise, the Philippines produced an estimated 596.34 thousand metric tons of mangoes 
during the April to June 2023 quarter, marking an 11.4 percent 
increase from the 535.43 thousand metric tons harvested in the same three-month period of 
2022. Of this total output, the mango variety accounted for the vast 
majority at 495.06 thousand metric tons, or 83.0 percent of the nation's entire mango
production \citep{psa2023major}.
...
and cracks on the fruit as these aspects affect the
...
sensors, and 3-layer \acr{CNN}. To classify the mangoes,
...
used as a model for the 3-layer \acr{CNN}. After extracting
the features of the mango, the 3-layer \acr{CNN} is used as a
...
Furthermore, the article presented by \citet{guillergan-naive-2024}
...
necessity. The physical deformities of the mango can determine the
...
Furthermore, most of the journal articles have a fix static method in grading and sorting the mangoes.
...
system. As such the proposed system would assess the quality of the
 mango based on all the mentioned mango traits, namely size,
...
mentioned, there is a need to develop a user priority based mango sorter that 
takes into
...
\begin{center}
	{\scriptsize
		\begin{longtable}{p{0.3\textwidth}|p{0.6\textwidth}}
          ...
          \gls{Convolutional Neural Network} capable of distinguishing bruised and non-bruised mangoes.
        ...
        \item To obtain an evaluation report of performance metrics of both \acr{CNN} and other machine learning models.
			\end{itemize} \\ \hline
...
and grader to manual human labor \citep{chakraborty-development-2023}. 

Another benefit to the automation of sorting and grading mangoes is the improvement in
...
for commercial farms and processing plants.
