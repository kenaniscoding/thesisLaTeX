...
description={A type of deep neural network that is highly effective in analyzing
	and processing visual data, such as images. CNNs mimic the human
	brain's approach to processing visual information through the use of
	neurons to learn patterns and identify them in images.},% brief description
plural={}% the plural
]%
{CNN}% the name
...
\newterm
[%
description={Techniques such as noise reduction that are used to enhance data for
	analysis},% brief description
plural={}% the plural
]%
{image preprocessing}% the name
